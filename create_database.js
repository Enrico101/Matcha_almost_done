...
db.query("CREATE TABLE IF NOT EXISTS likes (username VARCHAR(255) NOT NULL, likes VARCHAR(255) NOT NULL, like_back INT NOT NULL, room_id INT NOT NULL);", (err, succ) => {
    if (err)
        console.log(err);
    else if (succ)
